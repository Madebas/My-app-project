...
function HeroText({ openApplicationModal }) {
  ...
  return (
    <div className="flex flex-col gap-6 justify-center items-center text-center px-4">
      ...
      >
        At Johans Medical and Health Sciences Training Institute, we prepare
        tomorrow’s healthcare leaders through leading programs, hands-on
        clinical training, and a strong commitment to community care. Join us in
        shaping a healthier future for Kenya and beyond.
      </motion.p>
