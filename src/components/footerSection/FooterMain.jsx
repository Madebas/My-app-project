...
function FooterMain() {
  return (
    <motion.footer
      ...
      className="bg-gradient-to-b from-[#003366] via-[#1e3a8a] to-[#2a5caa] text-white py-8 px-4"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-sm text-gray-300 mb-4">
            ...
            world-class training and innovation.
          </p>
          <p className="text-sm text-gray-200">
            KISUMU, Kenya | +254 742451676 | admissions@johansmedical.ac.ke
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-6 pt-4 border-t border-[gold]/20 text-center">
        <p className="text-xs text-gray-400">
          © 2025 Johans Medical and Health Sciences Training Institute. All
          rights reserved.
        </p>
      </div>
    </motion.footer>
